...
CREATE TABLE `shop_address`  (
  ...
  `province` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '省名称',
  `province_id` bigint(11) DEFAULT NULL COMMENT '省id',
  `user_id` bigint(20) DEFAULT NULL COMMENT '用户id',
  `city` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '城市名称',
  `city_id` bigint(11) DEFAULT NULL COMMENT '城市id',
  `area` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '区域名称',
  `area_id` bigint(11) DEFAULT NULL COMMENT '区域id',
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '收货人名称',
  `phone` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '收货人手机号',
...
) ENGINE = InnoDB AUTO_INCREMENT = 68 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '收货地址表' ROW_FORMAT = Compact;
...
CREATE TABLE `shop_admin`  (
  ...
  `phone` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '用户手机号',
  `insert_time` datetime(0) DEFAULT NULL COMMENT '注册时间',
...
CREATE TABLE `shop_buy_car`  (
  ...
  `insert_time` datetime(0) DEFAULT NULL COMMENT '创建时间',
  `buy_count` int(255) DEFAULT NULL COMMENT '购买数量',
  `order_no` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '订单编号(结算后设置)',
...
CREATE TABLE `shop_dept`  (
  ...
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '部门备注',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `id_index`(`id`) USING BTREE
...
CREATE TABLE `shop_goods`  (
  ...
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '商品备注',
  `count` int(11) DEFAULT NULL COMMENT '商品库存',
  `logo` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '商品logo（保存图片路径）',
  `pics` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '商品细节图片（多个图片地址用逗号分隔）',
  ...
  INDEX `status_index`(`is_on_sale`) USING BTREE
...
CREATE TABLE `shop_goods_type`  (
  ...
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '商品类型备注',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `id_index`(`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `shop_log`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `path` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '请求路径',
  `ip` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '请求客户端的ip',
  `insert_time` datetime(0) DEFAULT NULL COMMENT '创建时间',
  `user_id` bigint(20) DEFAULT NULL COMMENT '请求人id',
  `user_account` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '请求人账号',
  `user_nickname` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '请求人昵称',
  `method` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '请求的method',
  `request` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '请求内容',
  `response` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '响应数据',
  `status_code` int(255) DEFAULT NULL COMMENT '请求的状态码',
  `action` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '请求行为（暂时无用）',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `id_index`(`id`) USING BTREE,
  INDEX `path_index`(`path`) USING BTREE,
  INDEX `method_index`(`method`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10940 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `shop_menu`  (
  ...
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '菜单备注',
  `level` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '菜单等级',
...
CREATE TABLE `shop_order`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `order_no` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '订单编号',
  `insert_time` datetime(0) DEFAULT NULL COMMENT '创建时间',
  `goods_id` bigint(20) DEFAULT NULL COMMENT '商品id',
  ...
  `goods_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '购买商品名称',
  ...
  `fallback_time` datetime(0) DEFAULT NULL COMMENT '退款时间',
  `fallback_reason` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '退款原因',
  `fallback_img` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '退款截图（暂时无用）',
  `express_no` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '快递物流编号',
  `activity_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '订单参与活动名称',
...
CREATE TABLE `shop_team`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '活动名称',
  `size` int(11) DEFAULT NULL COMMENT '活动商品库存',
  `goods_id` bigint(20) DEFAULT NULL COMMENT '商品id',
  `insert_time` datetime(0) DEFAULT NULL COMMENT '创建时间',
  `end_time` datetime(0) DEFAULT NULL COMMENT '活动过期时间',
  ...
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '活动备注',
